...
namespace DevelopmentTests
{
    ...
    public class DependencyGraphTest
    {
        ...
        ///<summary>
        ///Dependees(s) size is obtainable
        ///</summary>
        [TestMethod()]
        public void DependeesSizeTest()
        {
            ...
            Assert.AreEqual(0, dg["d"]);
        }

        ///<summary>
        ///Empty dependency graph has no dependees
        ///</summary>
        [TestMethod()]
        public void HasDependeesEmptyTest()
        {
            DependencyGraph dg = new DependencyGraph();
        ...
        ///<summary>
        ///Dependency graph has dependees
        ///</summary>
        [TestMethod()]
        ...
        ///<summary>
        ///Empty dependency graph has no dependents
        ///</summary>
        [TestMethod()]
        public void HasDependentsEmptyTest()
        {
            DependencyGraph dg = new DependencyGraph();
        ...
        ///<summary>
        ///Dependency graph has dependents
        ///</summary>
        [TestMethod()]
